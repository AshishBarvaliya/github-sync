...
@frappe.whitelist()
def validate(doc, method, *args, **kwargs):
    if not doc.github_sync_github_issue_number and doc.project:
        connection = frappe.db.get_value("Github Connection", {"project": doc.project}, ["tasks_naming_series"], as_dict=1)
